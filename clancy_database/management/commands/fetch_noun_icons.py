...
class Command(BaseCommand):
    def add_arguments(self, parser: CommandParser) -> None:
        parser.add_argument("--input_file", required=True, type=argparse.FileType("r"), help="Clancy master spreadsheet as a csv")
        parser.add_argument("--output_file", required=True, type=str, help="The name of the output file.")
        parser.add_argument("--level", required=True, type=str, help="The Clancy classification word level, i.e. 1E, 2I, 3A etc")
