...
"""
    ...
    def after_load_stats(self):
        ...
        self.stdout.write("Lemma RNC counts: {percent_lemmas:.0%} ({found_lemmas}/{total_lemmas})".format(
        ...
        self.stdout.write("Form RNC counts: {percent_forms:.0%} ({found_forms}/{total_forms})".format(
